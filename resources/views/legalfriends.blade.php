...
<body>
    <div class="relative w-full  h-[600px]">
        ...
        <img src="{{ asset('images/lawyers/saulgoodman.jpg') }}" alt="Image" class="w-full object-cover h-full">
            ...
            <div class="flex-grow flex items-center justify-center px-6 pb-15">
                <div class="text-center">
                    <h1 class="text-white text-4xl font-bold">
                        <span class="line-through">Lawyers</span> Legal Friends for Hire
                    </h1>
                    <p class="text-white text-2xl mt-2">
                        Don't hire a Criminal Lawyer, hire a CRIMINAL Lawyer.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="w-[90%] mx-auto mt-12 grid grid-cols-3 gap-8">
        @foreach($products as $product)
            @if($product->category === 'legalfriends')
            <div>
