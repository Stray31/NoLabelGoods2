...
<body>
    <div class="relative w-full  h-[600px]">
        <img src="{{ asset('images/guns.webp') }}" alt="Image" class="w-full object-cover h-full">
            ...
            <div class="flex-grow flex items-center justify-center px-6 pb-15">
                <div class="text-center">
                    <h1 class="text-white text-4xl font-bold">
                        <span class="line-through">Guns</span> Toys
                    </h1>
                    <p class="text-white text-2xl mt-2">
                        Plastic, spring loaded, and suspiciously realistic.
                    </p>
                </div>
            </div>
        </div>
